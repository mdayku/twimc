test:
	cd server && npx tsx test_schema.test.js && npx tsx test_pii.test.js && npx tsx test_docx.test.js && npx tsx test_docx_export.test.js && npx tsx test_fallback_template.test.js
